...
export const DappLogoWithChain: React.FC<DappLogoWithChainProps> = ({
  name,
  logoPath,
  chainLogoPath,
  color,
  ...
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '12vh auto' }}>
        ...
        <div
          className={`${styles['blur-common']} ${styles['filter-50']} ${backgroundGradient2} ${pulsateGrowClass50}`}
        ></div>
        <div
          className={`${styles['blur-common']} ${styles['filter-65']} ${backgroundGradient2} ${pulsateGrowClass65}`}
        ></div>
        <div
          className={`${styles['blur-common']} ${styles['filter-80']} ${backgroundGradient2} ${pulsateGrowClass80}`}
        ></div>
        <div
          className={`${styles['blur-common']} ${styles['filter-95']} ${backgroundGradient2} ${pulsateGrowClass95}`}
        ></div>
        ...
        <div className={`${styles['text-dapp']} ${unveilClass}`}>{name}</div>
      </div>
    </>
  );
};
