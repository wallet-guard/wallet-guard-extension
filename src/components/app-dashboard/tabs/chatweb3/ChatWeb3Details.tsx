...
const ChatWeb3DetailsColumn = (props: ChatWeb3DetailsColumnProps) => {
  return (
    ...
    >
      <div className={styles.flexCenter}>{sun}</div>
  ...
  return (
    ...
    >
      ...
      <ChatWeb3DetailsColumn title="Limitations" image={alert}>
        ...
        <ChatWeb3DetailTextBox>May produce biased content</ChatWeb3DetailTextBox>
        <ChatWeb3DetailTextBox>Always do your own research</ChatWeb3DetailTextBox>
      </ChatWeb3DetailsColumn>
    </div>
  );
};
