...
export const ModelSelect: FC<Props> = ({ model, models, onModelChange }) => {
  return (
    <div className="flex flex-col">
      ...
      <select
        className="w-full p-3 dark:text-white dark:bg-[#161616] border border-neutral-500 rounded-lg appearance-none focus:shadow-outline text-neutral-900 cursor-pointer"
