              ...
              <div className="card h-100" style={{ backgroundColor: '#121212', minWidth: '220px' }}>
                <div className="card-body">
                  <div className="row pb-3">
                    ...
                    <div className='col-9'>
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLScQ-g4WB3xFoO8_6cF5yXGu0myqcKdj4QhWi3LD9AKfwLaicQ/viewform?usp=sf_link"  target="_blank">Submit Feedback</a>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-3">
                    ...
                    <div className='col-9'>
                      <a href="https://chrome.google.com/webstore/detail/wallet-guard/pdgbckgdncnhihllonhnjbdoighgpimk" target="_blank">Leave a Review</a>
                    </div>
                  </div>
                </div>
              </div>
