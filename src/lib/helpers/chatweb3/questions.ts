...
export const chatWeb3QuestionsRefactored: ChatWeb3QuestionsRefactored = {
  ...
  'mint.fun': [
    { original: 'What is Mint?', reformatted: 'Could you tell me more about Mint on mint.fun?' },
  ...
  'guild.xyz': [
    { original: 'What is Guild?', reformatted: 'Could you explain what Guild is on guild.xyz?' },
  ...
  'revoke.cash': [
    { original: 'What is Revoke?', reformatted: 'Can you tell me what Revoke is on revoke.cash?' },
